...
class u07_LiveViewRev13(UsageRevisionBase):
    ...
    def _init_registers(self):
        ...
        self.reg_ae_self_test_frame_trans_clipping = 0
        self.reg_ae_self_test_frame_trans_overflow = 0
        self.reg_ae_self_test_frame_abs_cols_clipping = 0
        self.reg_ae_self_test_frame_abs_rows_clipping = 0
        self.reg_ae_self_test_frame_abs_overflow = 0
        self.reg_ae_self_test_frame_aux_clipping = 0
        self.reg_ae_self_test_frame_aux_overflow = 0
    ...
    def unpack(self):
        ...
        self.reg_ae_self_test_frame_trans_clipping = (field6 & 0x0001)
        self.reg_ae_self_test_frame_trans_overflow = (field6 & 0x0002) >> 1
        self.reg_ae_self_test_frame_abs_cols_clipping = (field6 & 0x0004) >> 2
        self.reg_ae_self_test_frame_abs_rows_clipping = (field6 & 0x0008) >> 3
        self.reg_ae_self_test_frame_abs_overflow = (field6 & 0x0010) >> 4
        self.reg_ae_self_test_frame_aux_clipping = (field6 & 0x0020) >> 5
        self.reg_ae_self_test_frame_aux_overflow = (field6 & 0x0040) >> 6
        ...
        max, min, sum, count, peak2peak = struct.unpack("<2HI2H", bytes(bytearray(self._usage_binary_data[86:98])))
        ...
        max, min, sum, count, peak2peak = struct.unpack("<2HI2H", bytes(bytearray(self._usage_binary_data[98:110])))
        ...
        max, min, sum, count, peak2peak = struct.unpack("<2HI2H", bytes(bytearray(self._usage_binary_data[110:122])))
        ...
        max, min, sum, count, peak2peak = struct.unpack("<2HI2H", bytes(bytearray(self._usage_binary_data[122:134])))
        ...
        field0, field1, field2, field3, field4 = struct.unpack("<3H2B", bytes(bytearray(self._usage_binary_data[134:142])))
        ...
        field0, field1, field2, field3 = struct.unpack("<4H", bytes(bytearray(self._usage_binary_data[142:150])))
        ...
        field0, field1, field2, field3, field4 = struct.unpack("<5H", bytes(bytearray(self._usage_binary_data[150:160])))
        ...
        field0, field1, field2, field3 = struct.unpack("<4H", bytes(bytearray(self._usage_binary_data[160:168])))
        ...
        field0, field1, field2, field3, field4 = struct.unpack("<5H", bytes(bytearray(self._usage_binary_data[168:178])))
        ...
        field0, field1, field2, field3 = struct.unpack("<4H", bytes(bytearray(self._usage_binary_data[178:186])))
        ...
        field0, field1, field2, field3, field4 = struct.unpack("<5H", bytes(bytearray(self._usage_binary_data[186:196])))
    ...
    def print_registers(self):
        ...
        print("    Channel : %5s %5s %5s %5s" % ("0", "1", "2", "3"))
        print("    Signal  : %5u %5u %5u %5u" % (self.reg_u83_self_test_frame_stats_aux_max[0], self.reg_u83_self_test_frame_stats_aux_max[1], self.reg_u83_self_test_frame_stats_aux_max[2], self.reg_u83_self_test_frame_stats_aux_max[3]))
        print("")
        ...
        print("     Trans Operating Point Errors    : %13s %13s %13s" % (u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_trans_operating_point[0]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_trans_operating_point[1]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_trans_operating_point[2])))
        print("     Abs Cols Operating Point Errors : %13s %13s %13s" % (u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_cols_operating_point[0]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_cols_operating_point[1]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_cols_operating_point[2])))
        print("     Abs Rows Operating Point Errors : %13s %13s %13s" % (u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_rows_operating_point[0]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_rows_operating_point[1]), u07_Utils.convert_self_test_result_to_string(self.reg_u83_channel_status_abs_rows_operating_point[2])))
        ...
        print("    Trans Clipping        : %s" % ("Clipping" if self.reg_ae_self_test_frame_trans_clipping == 1 else "Not Clipping"))
        print("    Trans Overflow        : %s" % ("Overflow" if self.reg_ae_self_test_frame_trans_overflow == 1 else "Not Overflow"))
        print("    Abs Cols Clipping     : %s" % ("Clipping" if self.reg_ae_self_test_frame_abs_cols_clipping == 1 else "Not Clipping"))
        print("    Abs Rows Clipping     : %s" % ("Clipping" if self.reg_ae_self_test_frame_abs_rows_clipping == 1 else "Not Clipping"))
        print("    Abs Overflow          : %s" % ("Overflow" if self.reg_ae_self_test_frame_abs_overflow == 1 else "Not Overflow"))
        print("    Aux Clipping          : %s" % ("Clipping" if self.reg_ae_self_test_frame_aux_clipping == 1 else "Not Clipping"))
        print("    Aux Overflow          : %s" % ("Overflow" if self.reg_ae_self_test_frame_aux_overflow == 1 else "Not Overflow"))
