...
#region u06 Self Test Usage Revision 3
    ...
    def _unpack_uifrev3(self):
        ...
        field0, field1, field2, field3, field4, field5, field6, field7 = struct.unpack("<8H", bytes(bytearray(self._usage_binary_data[100:116])))
    ...
    def _print_registers_uifrev3(self):
        ...
        print("    Max : %5u %5u %5u %5u" % (self.reg_self_test_8_aux_limits_chan_n_chan_max[0], self.reg_self_test_8_aux_limits_chan_n_chan_max[1], self.reg_self_test_8_aux_limits_chan_n_chan_max[2], self.reg_self_test_8_aux_limits_chan_n_chan_max[3]))
        print("    Max : %5u %5u %5u %5u" % (self.reg_self_test_8_aux_limits_chan_n_chan_min[0], self.reg_self_test_8_aux_limits_chan_n_chan_min[1], self.reg_self_test_8_aux_limits_chan_n_chan_min[2], self.reg_self_test_8_aux_limits_chan_n_chan_min[3]))
#endregion
