...
class u07_LiveViewRev7(u07_LiveViewRev6):
    """
    u07 Live View Revision 7: Functionally identical to Revision 6, but specific to AX198A.
    The only difference is that for Test 2 (AE Internal RAM test), Revision 7 provides an
